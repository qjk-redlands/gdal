...
/* We do not define LT_BIG_ENDIAN, as that would just confuse things;
   ...
   #define LT_LITTLE_ENDIAN
#elif defined(__arm64) || defined(__arm64__) || defined(_M_ARM64) || defined (__ARM_NEON)
...
#if defined(LT_OS_WIN) && defined(WINAPI_FAMILY) && (WINAPI_FAMILY == WINAPI_FAMILY_APP)
   /* windows universal apps run use a subset of the Desktop API */
   #define LT_OS_WINUWP 1
#endif
